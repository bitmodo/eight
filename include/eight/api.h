...
#define EIGHT_VERSION HEDLEY_VERSION_ENCODE(EIGHT_VERSION_MAJOR, EIGHT_VERSION_MINOR, EIGHT_VERSION_REVISION)

#define EIGHT_VERSION_0_1 HEDLEY_VERSION_ENCODE(0, 1, 0)
